<template>
    <div id='vuewrapper' style="height: 100%;">
        ...
        <AIAssistantWidget @close="state.showAIAssistant = false" v-if="state.showAIAssistant"></AIAssistantWidget>
...
import AIAssistantWidget from '@/components/widgets/AIAssistantWidget.vue'
import Vue from 'vue'
